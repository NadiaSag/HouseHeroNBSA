            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                if (snapshot.exists()) {
                    for (professionalSnapshot in snapshot.children) {
                        ...
                        val phoneNum = professionalSnapshot.child("phoneNum").value?.toString()
        ...
        reviewQuery.addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                if (snapshot.exists()) {
                    ...
                    Toast.makeText(this@ProfessionalInfoActivity, "Mostrando", Toast.LENGTH_SHORT).show()
                } else {
                    Toast.makeText(this@ProfessionalInfoActivity, "No hay reseñas", Toast.LENGTH_SHORT).show()
                }
            }
